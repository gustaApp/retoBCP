...
namespace RetoBCP.Infraestructura.Datos.Contextos
{
    public class TarifaContexto : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder options) {
            options.UseSqlServer($"Server=tcp:serverretobcp.database.windows.net,1433;Initial Catalog=app-tipocambio;Persist Security Info=False;User ID=adminretobcp;Password=@dminretoBCP;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate={TRUST_SERVER_CERTIFICATE}; Integrated Security={INTEGRATED_SECURITY};Connection Timeout=30;");
